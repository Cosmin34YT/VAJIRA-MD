...
global.owner = process.env.OWNER_NUMBER  || '0770811929' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=PE8AnDJJ#JrSCCkSsXAmayaz1LKh90xS6Yq0_kY6H-qNj4YTQsuE' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "0770811929,0770811929" : process.env.MODERATORS ,    
